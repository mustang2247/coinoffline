...
describe('Job e2e test', () => {
    ...
    it('should load Jobs', () => {
        ...
        expect(jobComponentsPage.getTitle()).toMatch(/coinofflineApp.job.home.title/);
    ...
    it('should load create Job dialog', () => {
        ...
        expect(jobDialogPage.getModalTitle()).toMatch(/coinofflineApp.job.home.createOrEditLabel/);
        jobDialogPage.close();
    });
